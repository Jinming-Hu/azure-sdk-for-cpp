  ...
  - from: swagger-document
    ...
    transform: >
      ...
      $.ListBlobsInclude.items["x-ms-enum"]["values"] = [
          ...
          {"value": "uncommittedblobs", "name": "UncommittedBlobs"},
  ...
  - from: swagger-document
    ...
    transform: >
      ...
      $.responses["201"].schema = {
        ...
        "x-ms-sealed": false,
        "properties": {
          "Created": {"type": "boolean", "x-ms-client-default": true, "x-ms-xml": {"name": ""}, "description": "Indicates if the page blob was successfully created by this operation."}
        }
      };
